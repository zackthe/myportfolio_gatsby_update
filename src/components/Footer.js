    ...
    <footer className="footer">
      <div className="footer-title-wraper">
        ...
        <div className="alert-msg-container">
          <p
            className={isCopied ? "alert-msg-show" : "alert-msg"}
            ref={copytext}
          >
            email copied <FaSmile color="white"></FaSmile>
          </p>
        </div>
        <button className="footer-btn btn" onClick={copyToClipboard}>
          Copy email
        </button>
      </div>
      ...
      {/*<p style={{ textAlign: "center", fontSize: "1.3em" }}>
        This site is built using gatsby <GrGatsbyjs></GrGatsbyjs> open sourced
        on github <FaGithub></FaGithub> deployed on netlify{" "}
        <SiNetlify></SiNetlify>
      </p>*/}
    </footer>
  );
